...
### Operations
1. Using the *cancer* dataframe, create a new vector (Cdiff) by calculating the total difference in cist numbers(inital to week 4). 
2. Append *Cdiff* to your dataframe. **Hint** *cbind*() 
