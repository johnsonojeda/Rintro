---
title: "Introduction to R | Importing and Exporting data files"
...
Once our data is loaded to the R environment, we can take a quick look at these
as a table

```{r, eval = FALSE}
view(sas)
```
We can also do this by double-clicking on the R object in the *Environment* tab 
in the upper right window of **RStudio**.
